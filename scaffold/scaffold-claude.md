...
**Audit complet de sante projet** (guide EBSE `project-health-audit` — GRADE 3/7 RECOMMANDE) : complement de l'audit pre-release, a frequence trimestrielle ou avant release majeure. Perimetre : tous les repos, toutes les dimensions ISO 25010. Methode : agents specialises par dimension en parallele (securite, fiabilite, maintenabilite, accessibilite, performance, architecture, conformite legale). Format de finding : `[LABEL] titre + severite + fichier:ligne + regle + correction`. Fondement : Olalekan & Osofisan — l'audit structure detecte 2.75x plus de defauts que l'ad hoc (seuil PICOC : >20pp) ; IEEE 1028-2008 + ISO 25040:2024 fournissent le cadre procedural ; OWASP WSTG/ASVS fournissent la grille securite. Voir guide complet : `ebse-scaffold/ebse/guide/02-domains/project/project-health-audit.md`. [RECOMMANDE — score GRADE 3/7] `Source: project-health-audit SLR 2026-04-23 (IEEE 1028-2008, ISO 25040:2024, SWEBOK v4, OWASP WSTG v4.2, OWASP ASVS 4.0.3, McIntosh EMSE 2020, Olalekan & Osofisan)`

**Inventaire sources de verite avant audit** (guide EBSE `audit-sources` — GRADE 5/9 RECOMMANDE) : AVANT d'ouvrir un seul fichier du projet, constituer l'inventaire de TOUTES les sources applicables en 4 tiers : (1) Normes universelles selon profil projet (OWASP ASVS, WCAG, RGPD, RGAA, HDS... — derivees de l'arbre de decisions) ; (2) Docs officielles des outils (TypeScript, ESLint, Vite, NestJS, Prisma, Docker, GitHub Actions...) ; (3) Conventions projet (CONVENTIONS.md par repo) ; (4) Decisions d'architecture (modules.md, ADRs). Chaque finding doit referencer une source explicite (Tier 1-4). IEEE 1028-2008 §6.4 prescrit de documenter les standards de reference avant de commencer ; Fagan 1976 demontre +67-82% de detection avec criteres pre-specifies. Voir guide : `ebse-scaffold/ebse/guide/02-domains/project/audit-sources.md`. [RECOMMANDE — score GRADE 5/9] `Source: audit-sources SLR 2026-04-23 (IEEE 1028-2008, ISO 25040:2024, NIST SP 800-53A, Fagan 1976, Porter 1995)`
