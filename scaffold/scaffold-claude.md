...
**Audit complet de sante projet — utiliser `/audit`** (guide EBSE `project-health-audit` — GRADE 3/7, `audit-sources` — GRADE 5/9) : complement de l'audit pre-release, a frequence trimestrielle ou avant release majeure. Procedure complete : `ebse-scaffold/scaffold/commands/audit.md` (commande `/audit`). En resume : (1) charger les sources — recos EBSE + Tier 1 normes + Tier 2 docs outils + Tier 3 conventions + Tier 4 architecture ; (2) inventaire projet — mapper chaque source vers les fichiers concernes (glob patterns dans la commande) ; (3) agents specialises par dimension ISO 25010 en parallele ; (4) findings → GitHub issues. Chaque finding cite sa source explicite. Fondement : Olalekan & Osofisan — audit structure 2.75x plus de defauts que l'ad hoc ; IEEE 1028-2008 + ISO 25040:2024 cadre procedural ; Fagan 1976 — pre-specification criteres +67-82% detection. [RECOMMANDE — GRADE 3-5/9] `Source: project-health-audit SLR 2026-04-23 + audit-sources SLR 2026-04-23`
