...
| Secrets | Env vars + GitHub Secrets + GitLeaks | [STANDARD] | 6/7 | [secrets-management](../02-domains/security/secrets-management.md) |
...
|----------|--------|--------|-------|------|
| Spacing | 8px grid (4/8/12/16/24/32/48) | [RECOMMANDE] | 3/7 | [spacing](../02-domains/design/spacing.md) |
| Typographie | Body 16px, line-height 1.5, max 75 chars | [STANDARD] | 6/7 | [typography](../02-domains/design/typography.md) |
| Couleurs | 2-3 teintes + neutres, contraste 4.5:1 | [STANDARD] | 6/7 | [colors](../02-domains/design/colors.md) |
| Animations | 200-300ms, ease-out/ease-in | [RECOMMANDE] | 3/7 | [animations](../02-domains/design/animations.md) |
| Shadows | Subtiles, diffuses (sm/md/lg) | [BONNE PRATIQUE] | 2/7 | [shadows](../02-domains/design/shadows.md) |
| Responsive | Mobile-first, Tailwind breakpoints | [RECOMMANDE] | 3/7 | [responsive](../02-domains/design/responsive.md) |
...
| i18n | react-i18next | [RECOMMANDE] | 3/7 | [i18n](../02-domains/accessibility/i18n.md) |
...
| E2E | Playwright | [RECOMMANDE] | 4/7 | [e2e-tests](../02-domains/testing/e2e-tests.md) |
...
| Decision | Outil | Niveau | Score | Page |
|----------|-------|--------|-------|------|
| Monitoring | Prometheus + Grafana | [RECOMMANDE] | 3/7 | [monitoring](../02-domains/reliability/monitoring.md) |
| Error tracking | Sentry / GlitchTip | [RECOMMANDE] | 3/7 | [monitoring](../02-domains/reliability/monitoring.md) |
...
| API doc | OpenAPI / springdoc | [RECOMMANDE] | 3/7 | [openapi](../02-domains/architecture/openapi.md) |
...
| Precision | BigDecimal (monnaie) | [RECOMMANDE] | 3/7 | [numeric-precision](../02-domains/data/numeric-precision.md) |
